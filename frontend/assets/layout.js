(() => {
  ...
  const pages = {
    ...
    "customer-detail.html": { title: "客户详情", active: "customers", actions: ["deleteCustomer", "editCustomer", "createOrder", "newFollowup"] },
  ...
  const actionTemplates = {
    ...
    createOrder: '<button class="farock-button farock-button--primary" hidden id="customer-create-order-button" type="button"><span class="material-symbols-outlined">receipt_long</span><span>创建订单</span></button>',
    payment: '<button class="farock-button farock-button--primary" data-order-payment-shortcut type="button"><span class="material-symbols-outlined">payments</span><span>选择订单登记收款</span></button>',
